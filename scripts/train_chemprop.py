...
Usage:
    ...
    python scripts/train_chemprop.py --train data/train.csv --test data/test.csv --out results/chemprop_submission.csv
    python scripts/train_chemprop.py --epochs 50 --val-split 0.1 --batch-size 64
"""
